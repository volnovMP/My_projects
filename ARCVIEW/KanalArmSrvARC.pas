...
begin
  try
    ...
    begin
      SyncReady;
      WaitForSingleObject(hWaitKanal,20);
    end;
    ExitThread(0);
    result := 0;
  except
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin //------------------------ зафиксировать восстановление связи с сервером
              AddFixMessage(GetShortMsg(1,434,'1'),5,0);
        ...
        begin
          ...
          begin
            ...
            begin //------------------------ зафиксировать восстановление связи с сервером
              AddFixMessage(GetShortMsg(1,434,'2'),5,0); //-- Восстановление связи с УВК $
              InsArcNewMsg(0,434+$2000);
            end;
            FixedConnect[2] := true;
            if i >= 70 then
        ...
        begin
          case KanalSrv[2].State of
            ...
            begin //------------------------------------- прочитать данные из буфера трубы
              if not FixedConnect[2] then
              begin //---------------------- зафиксировать восстановление связи с сервером
                AddFixMessage(GetShortMsg(1,434,'2'),5,0);
                InsArcNewMsg(0,434+$2000); //---------------- Восстановление связи с УВК $
              end;
              FixedConnect[2] := true;
