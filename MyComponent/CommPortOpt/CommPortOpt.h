...
//---------------------------------------------------------------------------
class TCommPortOpt;
class TReadThreadOpt;
class TWriteThreadOpt;
class TStatusThreadOpt;
class TReadEventThreadOpt;
class TStatusEventThreadOpt;
#include "ThReadOpt.h"
...
//----------------------------------------------------------------------------------------
class PACKAGE TCommPortOpt : public TComponent
{
...
//------------------------------------------------------------------ объекты событий порта
		...
		TReadEventOpt FOnDataReceivedOpt; //----------- событие "выполнен прием пакета данных"
...
//------------------------------------------------------------------------- хэндлы событий
		HANDLE rtEventOpt; //----------------------------------- хэндл события "принят символ"
		HANDLE wtEventOpt; //--------------------------------- хэндл события "есть что писать"
		HANDLE reEventOpt; //----------------------- хэндл события "прочитаны байты из буфера"
		HANDLE seEventOpt; //----------------------- хендл события "произошло событие в порту"
...
//----------------------------------------------------------------------------------------
		_RTL_CRITICAL_SECTION ReadOptSection; //---- критическая секция чтения данных из порта
//----------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------
		__fastcall TCommPortOpt(TComponent* Owner);
		virtual __fastcall ~TCommPortOpt(void);
//----------------------------------------------------------------------------------------
__published:
...
//----------------------------------------------------------------------------- Com Config
	...
	//-------------------------------------------------------------------------------- Events
		...
		__property TReadEventOpt OnDataReceivedOpt  = {read=FOnDataReceivedOpt, write=FOnDataReceivedOpt};
