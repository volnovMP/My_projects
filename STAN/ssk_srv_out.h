...
__published:	// IDE-managed Components
  ...
  TTrayIcon *TrayIcon11;
	...
	TButton *Button5;
//----------------------------------- порт
	void __fastcall PriemVvod(unsigned char st,int kan);
  ...
  int __fastcall ZAPOLNI_KVIT1(int ar,int kn,int n_ou);
  ...
  void __fastcall ZAGRUZ_KOM_TUMS(char tms,
                                  char grp,
                                  char pdgrp,
                                  char bt,
                                  char kd_cmd);
